...
st.markdown(
    "<p style='font-size: 18px; color: #2E7D32;'>Interact with the 2025 Strategic Plan using this AI assistant. Ask about CAPEX, governance, GMP readiness, or investor protections.</p>",
    unsafe_allow_html=True
)
